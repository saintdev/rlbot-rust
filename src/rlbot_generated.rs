...
pub mod rlbot {
    ...
    pub mod flat {
        ...
        pub fn enum_name_collision_shape(e: CollisionShape) -> &'static str {
            let index = e as u8;
            ENUM_NAMES_COLLISION_SHAPE[index as usize]
        }
        ...
        pub fn enum_name_tile_state(e: TileState) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_TILE_STATE[index as usize]
        }
        ...
        pub fn enum_name_render_type(e: RenderType) -> &'static str {
            let index = e as i8 - RenderType::DrawLine2D as i8;
            ENUM_NAMES_RENDER_TYPE[index as usize]
        }
        ...
        const ENUM_MAX_QUICK_CHAT_SELECTION: i8 = 62;
        ...
        #[allow(non_camel_case_types)]
        const ENUM_VALUES_QUICK_CHAT_SELECTION: [QuickChatSelection; 63] = [
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_QUICK_CHAT_SELECTION: [&'static str; 63] = [
            "Information_IGotIt",
        ...
        pub fn enum_name_quick_chat_selection(e: QuickChatSelection) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_QUICK_CHAT_SELECTION[index as usize]
        }
        ...
        pub fn enum_name_player_class(e: PlayerClass) -> &'static str {
            let index = e as u8;
            ENUM_NAMES_PLAYER_CLASS[index as usize]
        }
        ...
        #[allow(non_camel_case_types)]
        const ENUM_VALUES_GAME_MODE: [GameMode; 6] = [
            GameMode::Soccer,
            GameMode::Hoops,
            GameMode::Dropshot,
            GameMode::Hockey,
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_GAME_MODE: [&'static str; 6] = [
            "Soccer",
            "Hoops",
            "Dropshot",
            "Hockey",
        ...
        pub fn enum_name_game_mode(e: GameMode) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_GAME_MODE[index as usize]
        }
        ...
        #[allow(non_camel_case_types)]
        const ENUM_VALUES_GAME_MAP: [GameMap; 42] = [
            GameMap::DFHStadium,
            GameMap::Mannfield,
        ...
        #[allow(non_camel_case_types)]
        const ENUM_NAMES_GAME_MAP: [&'static str; 42] = [
            "DFHStadium",
            "Mannfield",
            "ChampionsField",
            "UrbanCentral",
        ...
        pub fn enum_name_game_map(e: GameMap) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_GAME_MAP[index as usize]
        }
        ...
        pub fn enum_name_match_length(e: MatchLength) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_MATCH_LENGTH[index as usize]
        }
        ...
        pub fn enum_name_max_score(e: MaxScore) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_MAX_SCORE[index as usize]
        }
        ...
        pub fn enum_name_overtime_option(e: OvertimeOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_OVERTIME_OPTION[index as usize]
        }
        ...
        pub fn enum_name_series_length_option(e: SeriesLengthOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_SERIES_LENGTH_OPTION[index as usize]
        }
        ...
        pub fn enum_name_game_speed_option(e: GameSpeedOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_GAME_SPEED_OPTION[index as usize]
        }
        ...
        pub fn enum_name_ball_max_speed_option(e: BallMaxSpeedOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BALL_MAX_SPEED_OPTION[index as usize]
        }
        ...
        pub fn enum_name_ball_type_option(e: BallTypeOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BALL_TYPE_OPTION[index as usize]
        }
        ...
        pub fn enum_name_ball_weight_option(e: BallWeightOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BALL_WEIGHT_OPTION[index as usize]
        }
        ...
        pub fn enum_name_ball_size_option(e: BallSizeOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BALL_SIZE_OPTION[index as usize]
        }
        ...
        pub fn enum_name_ball_bounciness_option(e: BallBouncinessOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BALL_BOUNCINESS_OPTION[index as usize]
        }
        ...
        pub fn enum_name_boost_option(e: BoostOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BOOST_OPTION[index as usize]
        }
        ...
        pub fn enum_name_rumble_option(e: RumbleOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_RUMBLE_OPTION[index as usize]
        }
        ...
        pub fn enum_name_boost_strength_option(e: BoostStrengthOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_BOOST_STRENGTH_OPTION[index as usize]
        }
        ...
        pub fn enum_name_gravity_option(e: GravityOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_GRAVITY_OPTION[index as usize]
        }
        ...
        pub fn enum_name_demolish_option(e: DemolishOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_DEMOLISH_OPTION[index as usize]
        }
        ...
        pub fn enum_name_respawn_time_option(e: RespawnTimeOption) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_RESPAWN_TIME_OPTION[index as usize]
        }
        ...
        pub fn enum_name_existing_match_behavior(e: ExistingMatchBehavior) -> &'static str {
            let index = e as i8;
            ENUM_NAMES_EXISTING_MATCH_BEHAVIOR[index as usize]
        }
        ...
        impl<'a> PlayerInfo<'a> {
            ...
            pub fn hitboxOffset(&self) -> Option<&'a Vector3> {
                self._tab.get::<Vector3>(PlayerInfo::VT_HITBOXOFFSET, None)
            }
            /// In the case where the requested player index is not available,
            /// spawnId will help the framework figure out what
            /// index was actually assigned to this player instead.
            #[inline]
        ...
        impl<'a: 'b, 'b> PlayerInfoBuilder<'a, 'b> {
            ...
            #[inline]
            pub fn add_hitboxOffset(&mut self, hitboxOffset: &'b Vector3) {
                self.fbb_
        ...
        impl<'a> DesiredGameInfoState<'a> {
            ...
            pub fn paused(&self) -> Option<&'a Bool> {
                self._tab.get::<Bool>(DesiredGameInfoState::VT_PAUSED, None)
            }
            #[inline]
        ...
        impl<'a: 'b, 'b> DesiredGameInfoStateBuilder<'a, 'b> {
            ...
            #[inline]
            pub fn add_paused(&mut self, paused: &'b Bool) {
                self.fbb_
                    .push_slot_always::<&Bool>(DesiredGameInfoState::VT_PAUSED, paused);
            }
            #[inline]
            pub fn add_endMatch(&mut self, endMatch: &'b Bool) {
                self.fbb_
        ...
        impl<'a> PlayerLoadout<'a> {
            ...
            /// Sets the primary color of the car to the swatch that most
            /// closely matches the provided RGB color value. If
            /// set, this overrides teamColorId.
            #[inline]
            pub fn primaryColorLookup(&self) -> Option<Color<'a>> {
                self._tab.get::<flatbuffers::ForwardsUOffset<Color<'a>>>(
                    PlayerLoadout::VT_PRIMARYCOLORLOOKUP,
                    None,
                )
            }
            /// Sets the secondary color of the car to the swatch that most
            /// closely matches the provided RGB color value. If
            /// set, this overrides customColorId.
            #[inline]
